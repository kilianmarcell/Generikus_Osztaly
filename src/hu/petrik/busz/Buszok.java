...
public class Buszok {
    ...
    public static void Run() {
        ...
        Set<String> metszet = hetesBuszMegalloi.intersect(otosBuszMegalloi);


        System.out.println(String.format("%d megállóban áll meg az 5-ös busz.", otosBuszMegalloi.getSize()));
        System.out.println(String.format("%d megállóban áll meg a 7-es busz.", hetesBuszMegalloi.getSize()));
        System.out.println(String.format("%d közös megállójuk van.", metszet.getSize()));
